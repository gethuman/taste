 ...
 * @param opts
 */
function firstBite(opts) {
    loadModule = opts.require || require;
    targetDir = opts.targetDir || (__dirname + '/../../..');
...
function target(relativePath) {
    return loadModule(targetDir + '/' + relativePath);
}
